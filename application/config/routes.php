...
*/
$route['default_controller'] = 'User_HomeController';
$route['404_override'] = '';
...
$route['contact-us']['GET'] = 'User_HomeController/contactPage';
$route['messages-box']['GET'] = 'User_HomeController/messagesBox';
$route['messages-box/send']['POST'] = 'User_HomeController/messagesBox_send';

//Product
$route['products']['GET'] = 'User_ProductController/index';
$route['products/(:num)']['GET'] = 'User_ProductController/detail/$1';
$route['product/detail/comment']['GET'] = 'User_ProductController/save';
$route['product/detail/comment']['POST'] = 'User_ProductController/save';

//UserOrder
$route['orders/view']['GET'] = 'User_OrdersController/index';
$route['orders/add/(:num)']['GET'] = 'User_OrdersController/create_view/$1';
$route['orders/add']['POST'] = 'User_OrdersController/create_post';
$route['orders/cancel/(:num)']['GET'] = 'User_OrdersController/cancel/$1';
...
$route['admin/clothes-management/delete/(:num)']['GET'] = 'Admin_ClothesController/delete_post/$1';
